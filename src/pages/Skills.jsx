...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Python", "C", "C++", "Java" ,"Rust"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React"] },
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git"] },
    { title: "Frameworks & Libraries", items: ["TensorFlow", "PyTorch", "Scikit-learn"] },
    { title: "Machine Learning & Data Science", items: ["Scikit-learn", "Pandas", "NumPy", "TensorFlow", "PyTorch", "Matplotlib"]},
    { title: "Blockchain", items: ["Solidity", "Ethereum", "Web3.js", "Smart Contracts"] },
  ],
  [
