...
const IMAGES = {
  personal: [
    ...
    },
    {
      id: 2,
      caption:
        "Man gazing at serene sunset by lakeside",
      photos: ["rachit1.png"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "Innovative hackathon project focused on rapid problem-solving and building scalable solutions using modern technologies, featuring real-time functionality and an intuitive user experience.",
    ...
    
    {
      id: 1,
      caption:
        "AI-powered platform for analyzing real estate trends, property insights, and market predictions using interactive dashboards and data visualization.",
      photos: ["/gallery/profilex.png", "/gallery/profilex2.png","/gallery/profilex3.png", "/gallery/profilex4.png"],
    },
  ],
  achievements: [
    {
